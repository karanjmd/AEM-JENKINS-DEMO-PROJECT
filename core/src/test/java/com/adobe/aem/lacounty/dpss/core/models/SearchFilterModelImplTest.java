...
import com.adobe.aem.lacounty.dpss.core.models.impl.SearchFilterModelImpl;
...
public class SearchFilterModelImplTest {
	...
	void setUp() {
		...
		aemContext.load().json("/com/adobe/aem/lacounty/dpss/core/models/searchfilter.json", "/content");
