/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
package com.adobe.aem.lacounty.dpss.core.corecomponents.internal;
...
public class Utils {
    ...
    public static String getURL(@NotNull SlingHttpServletRequest request, @NotNull Page page) {
        ...
        if(StringUtils.isEmpty(vanityURL)) {
        	updatedUrl=request.getContextPath() + page.getPath() + ".html";
        }else {
        	updatedUrl=request.getContextPath() + vanityURL;
        }
        return updatedUrl;        		
    }
    
    @NotNull
    public static String getURL(@NotNull SlingHttpServletRequest request, @NotNull Asset asset) {
        return request.getContextPath() + asset.getPath();
    }
