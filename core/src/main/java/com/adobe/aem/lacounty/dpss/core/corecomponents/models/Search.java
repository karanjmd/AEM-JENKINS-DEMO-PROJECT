...
public interface Search extends ComponentExporter {
    ...
    String PN_SEARCH_ROOTS = "searchRoots";
    ...
    String PN_SEARCH_TERM_NO_INDEX_TAG= "searchTermNoIndexTag";
    ...
    @NotNull
    default String getSearchResultsNoIndexTag() {
        throw new UnsupportedOperationException();
    }
   ...
   default Map<String, String> getSearchRootPaths () {
	   throw new UnsupportedOperationException();
   }	
    ...
    */
	...
	default String getResultCountFormat() {
		throw new UnsupportedOperationException();
	}
	...
	String getSearchTermNoIndexTag();
}