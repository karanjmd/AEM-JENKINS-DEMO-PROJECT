...
@Component(service = ParticipantStepChooser.class, immediate = true, property = {
		"chooser.label=" + "Bureau Step Selection" })
public class BureauDynamicParticipantStep implements ParticipantStepChooser {
	private static final Logger log = LoggerFactory.getLogger(BureauDynamicParticipantStep.class);
	...
	public String getParticipant(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap)
		...
		if (Objects.nonNull(resource)) {
			...
			if (Objects.nonNull(configurationBuilder)) {
				...
				String[] bureauList = ePolicyApprovalConfiguration.bureau();
				String bureau = null;
