...
@Component(service = ParticipantStepChooser.class, immediate = true, property = {
		"chooser.label=" + "Branch Step Selection" })
public class BranchDynamicParticipantStep implements ParticipantStepChooser {
	private static final Logger log = LoggerFactory.getLogger(BranchDynamicParticipantStep.class);
	...
	public String getParticipant(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap)
		...
		if (Objects.nonNull(resource)) {
			...
			if (Objects.nonNull(configurationBuilder)) {
				...
				String[] branchList = ePolicyApprovalConfiguration.branch();
				String branch = null;
